...
\newcommand{\PPnewlang}{}
\newcommand{\PPnewlangEN}{\begin{paracol}{2}\begin{leftcolumn}\selectlanguage{english}\gdef\somelanguage{en}}
\newcommand{\PPnewlangAF}{\begin{rightcolumn}\selectlanguage{dutch}\gdef\somelanguage{af}}
...
\newcommand{\PPversei}[3]{\PPmeasuretext{\PPverseref{#2}\versehskip\ppspacing#3}}% the space after the verse is a thing
\newcommand{\PPverseii}[3]{%
  \ifdim\PPparaheight<1.1\baselineskip%
    \PPsyntheticpar% KQ% continue on same line
  \else
    \PPsyntheticparii% QK%
  \fi
    \PPmeasuretext{\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}\versehskip\PPverseref{#2}\ppspacing#3}}% the space after the verse is a thing
\newcommand{\PPverse}[3]{\par\PPmeasuretext{\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}\versehskip\PPverseref{#2}\ppspacing#3}}% the space after the verse is a thing
