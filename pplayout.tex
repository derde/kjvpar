...
\newcommand{\PPnewlang}{}
\newcommand{\PPnewlangEN}{\begin{paracol}{2}\begin{leftcolumn}}
\newcommand{\PPnewlangAF}{\begin{rightcolumn}}
\newcommand{\PPbook}[1]{\mybooktitlepreamble\mybooktitlebox{#1}}
\newcommand{\PPchapter}[1]{\PPdropcapschapter{#1}}
\newcommand{\PPversei}[2]{#2\PPsyntheticparii}% the space after the verse is a thing
\newcommand{\PPverseii}[2]{\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}#2\par}% the space after the verse is a thing
\newcommand{\PPverse}[2]{\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}#2\par}% the space after the verse is a thing
\newcommand{\PPpar}{\par}
\newcommand{\PPendlang}{\par}
\newcommand{\PPendlangEN}{\end{leftcolumn}}
\newcommand{\PPendlangAF}{\end{rightcolumn}\end{paracol}}
\newcommand{\PPendchapter}{\par}%
\newcommand{\PPendbook}{\par}
\newcommand{\PPend}{\par}
%\newcommand{\PPpagetitles}[2]{\lock{#1}{#2}}%
\newcommand{\PPonecolumn}{}%
% FIXI?
...
%\renewcommand{\PPonecolumn}{\par}%
\newcommand{\PPendlastbook}[1]{\PPonecolumn}%
...
\newcommand{\PPnewreference}[2]{\markboth{#1}{#1}\def\mythumbindex{#2}}%
