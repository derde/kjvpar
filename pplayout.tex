...
\newcommand{\PPversei}[2]{\ppspacing #2}% the space after the verse is a thing
\newcommand{\PPverseii}[2]{\PPsyntheticparii\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}\versehskip\ppspacing#2}% the space after the verse is a thing
\newcommand{\PPverse}[2]{\par\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}\versehskip\ppspacing#2}% the space after the verse is a thing
