...
\fancyhead[ER]{\pphcentre{\myheadingfont \textbf{\ppget{AFrange}{\thepage}}}\calcppmarker\PPthumbmarkleft{\theppmarker}}% Top right header
\fancyhead[OR]{\pphcentre{\myheadingfont \textbf{\ppget{AFrange}{\thepage}}}\PPthumbmarkright{\theppbookno}}% Top right header
...
% FIXI?
\newcommand{\PPthumbmark}[4]{% 1:horizontal tab, 2: vertical tab, 3: hspace, 4: lightgray
\begin{textblock}{1}(#1,#2)%
    %\rule[0em]{1em}{1ex}%
    \hfuzz=72pt
    \raisebox{0pt}[0pt]{\hspace{#3}\color{#4}\rule[0em]{8mm}{1.5em}}% vert offset, width, height
\end{textblock}
}
\newcommand{\PPthumbmarkright}[1]{\PPthumbmark{29}{#1}{0.5mm}{lightgray}}%
\newcommand{\PPthumbmarkleft}[1]{\PPthumbmark{0}{#1}{-4mm}{lightgray}}%
