...
\newcommand\PPtoc[2]{#1\hfill.. #2\par}
\def\mypageiii{
    \thispagestyle{noheadings}%
    %\fontsize{10}{10}\selectfont%
    \vfill
    %\bookheadingstrut{3\baselineskip}\par
    KJV 1953 Afrikaans Parallel Bible New Testament 2024
    \vfill
    {\mybooktitlefont\mybooktitlesettingsz\mybooktitletextbf{DIE BYBEL}}\par% King James Bible
    {\textsc\mybooktitlesettingsz Ou Vertaling, 1953\par Nuwe Testament}% kjvtex compactt
    \vfill
    {\mybooktitlefont\mybooktitlesettingsz\mybooktitletextbf{HOLY BIBLE}}\par% King James Bible
    {\textsc\mybooktitlesettingsz Authorised Version, 1611\par New Testament}% kjvtex compactt
    \vfill
http://soulwinnning.africa/af

\begin{paracol}{2}
\begin{leftcolumn}\PPtocAF\end{leftcolumn}
\begin{rightcolumn}\PPtocEN\end{rightcolumn}
\end{paracol}
\vfill
\par
\ENmotto
