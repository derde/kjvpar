...
\newcommand{\PPversei}[3]{\PPmeasuretext{\PPverseref{#2}\versehskip\ppspacing\pplang{#3}}}% the space after the verse is a thing
\newcommand{\PPverseii}[3]{%
  ...
  \else
    \PPsyntheticparii% QK%
  \fi
    \PPmeasuretext{\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}\versehskip\PPverseref{#2}\ppspacing\pplang{#3}}}% the space after the verse is a thing
\newcommand{\PPverse}[3]{\par\PPmeasuretext{\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}\versehskip\PPverseref{#2}\ppspacing\pplang{#3}}}% the space after the verse is a thing
