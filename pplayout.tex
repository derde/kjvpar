...
\newcommand{\PPversei}[3]{\ppspacing\PPverseref{#2} #3}% the space after the verse is a thing
\newcommand{\PPverseii}[3]{\PPsyntheticparii\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}\versehskip\ppspacing\PPverseref{#2}#3}% the space after the verse is a thing
\newcommand{\PPverse}[3]{\par\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}\versehskip\ppspacing\PPverseref{#2}#3}% the space after the verse is a thing
