...
\def\usepackages{%
    \usepackage[tracking,shrink=2,stretch=20]{microtype}
    ...
    \FPround{\myfontstretchAF}{\myfontstretchAF}{4}
}
...
The\par
New Testament\par
of our Lord and Saviour\par
JESUS CHRIST\par
Translated out of the original Greek:\par
and with the former translations\par
diligently compared and revised,\par
by his Majesty's special command
}
% Load default page counts, which is used for the print checker and thumbnail
\gdef \mypagecount {500}
...
\newcommand{\PPbookmarker}[1]{\PPthumbmark{0}{#1}{-4mm}{lightgray}{1.5em}}%
\newcommand{\PPpagemarker}[1]{\PPthumbmark{29}{#1}{0.5mm}{lightgray}{0.5em}}%
...
\def\ppPrefaceEN{
\myprefacefont
{\centering \color{mygray}\bf Calvary Hope Baptist Church}

This edition of the Bible has been prepared by Calvary Hope Baptist Church
(Cape Town) for the furtherance of the Gospel of Jesus Christ in South Africa.
A number of verses that are useful in teaching the Gospel of Christ with
...
the spelling and capitalisation revisions of 1769 (KJV).  The Afrikaans text is the
...
Both translations were translated from the received text in Greek: the English
was informed by prior translations in English and other languages, and the
Afrikaans was based on the Dutch Statenvertaling.  Both the KJV and the
1953 Afrikaans are superior to the wholesale revisions that followed them,
because the revisions are based on an inferior synthetic modern revision of the
text, and false theories of translation.
}
...
Dié uitgawe van die Bybel is deur Calvary Hope Baptist Church (Kaapstad) uitgegee
vir die bevordering van die Evangelie van Jesus Christus in Suid Afrika.  Enkele
verse wat dikwels gebruik word om die Evangelie van Chrisus met eenvoudigheid
te leer is in die teks beklemtoon.

Die Engelse teks is die Bybel van 1611 gemagtig deur Koning James van Engeland,
met die spelling en hoofletter hersienings van 1769 (KJV).  Die Afrikaanse teks
...
Albei vertalings is vertaal van die Griekse {\em Textus Receptus}: die Engels
was ingelig deur die vorige vertalings in Engels en ander tale, en die
Afrikaans het die Nederlandse Statenvertaling as beginpunt gebruik.  Beide die
die 1953 Ou Vertaling en die KJV is beter as die nuwe vertalings wat op hulle
gevolg het, omdat nuwe vertalings gebruik maak van 'n minderwaardige kunsmatige
moderne Griekse teks, en valse ideës oor vertaling.
\end{afrikaans}
}
...
\par
No headings; verses share lines; ragged; psalm titles; no epistle postscripts;\par
...
\begin{paracol}{2}%
    \begin{leftcolumn}%
        ...
        {\centering
            ...
            {\noindent\sc Authorised Version, 1611, KJV}\par
            {\noindent\sc New Testament}\par% kjvtex compactt
        }%
        \null\par
        \PPtocEN\par
    ...
    \begin{rightcolumn}%
        ...
        {\centering
            ...
            {\noindent\sc Ou Vertaling, 1953}\par
            {\noindent\sc Nuwe Testament}\par% kjvtex compactt
        }%
        \null\par
        \PPtocAF\par
        \bookheadingstrut{3\baselineskip}\null\par
