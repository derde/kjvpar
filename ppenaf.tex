...
%\newcommand{\ppfontadjust}{\addfontfeature{\myletterspace}% Tell fontspec to do letter spaces ... doesn't work
\newcommand{\ppfontadjust}{}
\newcommand{\PPnew}{}
...
\newcommand{\PPversei}[4]{\PPverseref{#2}\ppsaveposition{#3}\ppfontadjust\pplang{#4}\ppsavepositionk{#3}}% the space after the verse is a thing
\newcommand{\PPverseii}[4]{%
  ...
  %\else
    \PPsyntheticparii% QK%
  %\fi
\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}\ppsaveposition{#3}{\versehskip\PPverseref{#2}\ppfontadjust\pplang{#4}\ppsavepositionk{#3}}}% the space after the verse is a thing
\newcommand{\PPverse}[4]{\par\raisebox{\myverseraise}[0pt]{\myversefont\textbf{#1}}\ppsaveposition{#3}{\versehskip\PPverseref{#2}\ppfontadjust\pplang{#4}\ppsavepositionk{#3}}}% the space after the verse is a thing
