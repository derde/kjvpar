...
\def\myfontsize{9.20pt}
\def\mybaseline{9.20pt}
\def\myfontopts{
...
\newcommand{\PPchapterEN}[1]{\PPdropcapschapterNS{#1}}
\newcommand{\PPchapterAF}[1]{\PPdropcapschapter{#1}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\PPdropcapschapterNS}[1]{\needspace{\mychapterspace}\PPdropcapschapter{#1}}% big mystery here ... for needspace within 2 column environment, this is the number of lines /2 /2 (ie div 4)
