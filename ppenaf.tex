...
%  \parfillskip=0pt plus 10em\relax%   last line of paragraph space: use up all of the spare space here.
  \spaceskip=\dimexpr\the\fontdimen2\font-\the\fontdimen4\font\relax plus 0.3em % plus \the\fontdimen4\font % space between words: keep it constant, with tiny changes, no up-side
  \rightskip=0pt plus 1.0em\relax% space on right hand margin: keep it small
  \parfillskip=0pt plus \linewidth\relax%   last line of paragraph space: use up all of the spare space here.
}
\def\myletterspace{LetterSpace=1 plus 20 minus 1}
...
\def\ENsubtitle{kjb1769 afr1953 A5-440}
...
ISBN: 978-0-XXXX-XXXX-5, \copyright Calvary Hope 2024, with this licence:}
